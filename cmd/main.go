...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "25d1ccc8.noplane.io",
	...
	if err := (&controller.NoPlaneControlPlaneTemplateReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "NoPlaneControlPlaneTemplate")
		os.Exit(1)
	}
