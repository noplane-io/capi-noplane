...
type NoPlaneControlPlaneTemplateSpec struct {
	...
	// foo is an example field of NoPlaneControlPlaneTemplate. Edit noplanecontrolplanetemplate_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// NoPlaneControlPlaneTemplateStatus defines the observed state of NoPlaneControlPlaneTemplate.
type NoPlaneControlPlaneTemplateStatus struct {
	...
	// conditions represent the current state of the NoPlaneControlPlaneTemplate resource.
...
type NoPlaneControlPlaneTemplate struct {
	...
	// status defines the observed state of NoPlaneControlPlaneTemplate
	// +optional
	Status NoPlaneControlPlaneTemplateStatus `json:"status,omitzero"`
}
